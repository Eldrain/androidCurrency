 ...
 * Date: 20.12.2018
 * Module name: UsdCurrency
 * Description: USD currency
 */
class UsdCurrency(value : Int) : Currency() {
    ...
    override fun fillData(viewHolder: RecyclerView.ViewHolder) {
        val holder = viewHolder as UsdHolder
    ...
    class UsdHolder(view : View)
        : RecyclerView.ViewHolder(view) {
        val textValue = view.findViewById<TextView>(R.id.currencyUsdItemValue)
    }
}